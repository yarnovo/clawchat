...
import { SceneAkelIntro } from "./SceneAkelIntro";
import { SceneAkelDesign } from "./SceneAkelDesign";
import { SceneAkelSummary } from "./SceneAkelSummary";
import { Subtitle } from "../../Subtitle";

import akelIntroWords from "./words/akel-intro-words.json";
import akelDesignWords from "./words/akel-design-words.json";
import akelSummaryWords from "./words/akel-summary-words.json";
...
const SCENE_COMPS = [SceneAkelIntro, SceneAkelDesign, SceneAkelSummary];
const SCENE_WORDS = [akelIntroWords, akelDesignWords, akelSummaryWords];
...
export const AK_EVENT_LOOP_FRAMES = scenes[scenes.length - 1].from + scenes[scenes.length - 1].dur;
...
export const AkEventLoop: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
      <Audio src={staticFile("audio/ak-event-loop/ak-event-loop.mp3")} volume={0.9} />
      {scenes.map((s, i) => {
