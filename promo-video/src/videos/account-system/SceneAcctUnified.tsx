...
const fields = [
  { name: "id", type: "UUID", desc: "统一主键" },
  { name: "type", type: "human | agent", desc: "唯一区分", highlight: true },
  { name: "name", type: "String", desc: "显示名称" },
  { name: "avatar", type: "String?", desc: "头像" },
  { name: "email", type: "String?", desc: "邮箱（人类）" },
  { name: "searchable", type: "Boolean", desc: "可被搜索" },
];

export const SceneAcctUnified: React.FC = () => {
