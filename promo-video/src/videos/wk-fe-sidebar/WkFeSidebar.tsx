...
import wkfesShellWords from "./words/wkfes-shell-words.json";
import wkfesCodeWords from "./words/wkfes-code-words.json";
...
const SCENE_COMPS = [SceneShell, SceneCode];
const SCENE_WORDS = [wkfesShellWords, wkfesCodeWords];
...
export const WK_FE_SIDEBAR_FRAMES = scenes[scenes.length - 1].from + scenes[scenes.length - 1].dur;
...
export const WkFeSidebar: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
      <Audio src={staticFile("audio/wk-fe-sidebar/wk-fe-sidebar.mp3")} volume={0.9} />
      {scenes.map((s, i) => {
