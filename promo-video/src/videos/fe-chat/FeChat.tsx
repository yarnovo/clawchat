...
import fecIntroWords from "./words/fec-intro-words.json";
import fecBubbleWords from "./words/fec-bubble-words.json";
import fecInputWords from "./words/fec-input-words.json";
...
const SCENE_COMPS = [SceneIntro, SceneBubble, SceneInput];
const SCENE_WORDS = [fecIntroWords, fecBubbleWords, fecInputWords];
...
export const FE_CHAT_FRAMES = scenes[scenes.length - 1].from + scenes[scenes.length - 1].dur;
...
export const FeChat: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
    <Audio src={staticFile("audio/fe-chat/fe-chat.mp3")} volume={0.9} />
    {scenes.map((s, i) => {
