...
import wkfemRenderWords from "./words/wkfem-render-words.json";
import wkfemCopyWords from "./words/wkfem-copy-words.json";
...
const SCENE_COMPS = [SceneRender, SceneCopy];
const SCENE_WORDS = [wkfemRenderWords, wkfemCopyWords];
...
export const WK_FE_MARKDOWN_FRAMES = scenes[scenes.length - 1].from + scenes[scenes.length - 1].dur;
...
export const WkFeMarkdown: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
      <Audio src={staticFile("audio/wk-fe-markdown/wk-fe-markdown.mp3")} volume={0.9} />
      {scenes.map((s, i) => {
