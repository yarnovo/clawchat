...
import routesWords from "./words/wkfer-routes-words.json";
import codeWords from "./words/wkfer-code-words.json";
...
const SCENE_COMPS = [SceneRoutes, SceneCode];
const SCENE_WORDS = [routesWords, codeWords];
...
export const WK_FE_ROUTING_FRAMES = scenes[scenes.length - 1].from + scenes[scenes.length - 1].dur;
...
export const WkFeRouting: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
      <Audio src={staticFile("audio/wk-fe-routing/wk-fe-routing.mp3")} volume={0.9} />
      {scenes.map((s, i) => {
