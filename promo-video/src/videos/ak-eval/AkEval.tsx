...
import { SceneAkevIntro } from "./SceneAkevIntro";
import { SceneAkevDesign } from "./SceneAkevDesign";
import { SceneAkevSummary } from "./SceneAkevSummary";
import { Subtitle } from "../../Subtitle";

import akevIntroWords from "./words/akev-intro-words.json";
import akevDesignWords from "./words/akev-design-words.json";
import akevSummaryWords from "./words/akev-summary-words.json";
...
const SCENE_COMPS = [SceneAkevIntro, SceneAkevDesign, SceneAkevSummary];
const SCENE_WORDS = [akevIntroWords, akevDesignWords, akevSummaryWords];
...
export const AK_EVAL_FRAMES = scenes[scenes.length - 1].from + scenes[scenes.length - 1].dur;
...
export const AkEval: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
      <Audio src={staticFile("audio/ak-eval/ak-eval.mp3")} volume={0.9} />
      {scenes.map((s, i) => {
