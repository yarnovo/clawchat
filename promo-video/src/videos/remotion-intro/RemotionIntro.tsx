...
import { SceneEcosystem } from "./SceneEcosystem";
import { SceneOutro } from "./SceneOutro";
import { Subtitle } from "../../Subtitle";

import introWords from "./words/intro-words.json";
import conceptWords from "./words/concept-words.json";
...
import ecosystemWords from "./words/ecosystem-words.json";
...
const SCENE_COMPS = [
  SceneIntro, SceneConcept, SceneFeatures,
  SceneCompare, SceneScale, SceneEcosystem, SceneOutro,
];
const SCENE_WORDS = [
  introWords, conceptWords, featuresWords,
  compareWords, scaleWords, ecosystemWords, outroWords,
];
...
export const RemotionIntro: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
    <Audio src={staticFile("audio/remotion-intro/remotion-intro.mp3")} volume={0.9} />
    {scenes.map((s, i) => {
