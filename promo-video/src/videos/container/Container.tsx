...
import { SceneCtDesign } from "./SceneCtDesign";
import { SceneCtResources } from "./SceneCtResources";
import { SceneCtApi } from "./SceneCtApi";
import { SceneCtOutro } from "./SceneCtOutro";
import { Subtitle } from "../../Subtitle";

import ctIntroWords from "./words/ct-intro-words.json";
import ctDesignWords from "./words/ct-design-words.json";
import ctResourcesWords from "./words/ct-resources-words.json";
import ctApiWords from "./words/ct-api-words.json";
...
const SCENE_COMPS = [
  SceneCtIntro, SceneCtDesign, SceneCtResources,
  SceneCtApi, SceneCtOutro,
];
const SCENE_WORDS = [
  ctIntroWords, ctDesignWords, ctResourcesWords,
  ctApiWords, ctOutroWords,
];
...
export const Container: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
      <Audio src={staticFile("audio/container/container.mp3")} volume={0.9} />
      {scenes.map((s, i) => {
