...
import { SceneTaMock } from "./SceneTaMock";
import { SceneTaCases } from "./SceneTaCases";
import { SceneTaCi } from "./SceneTaCi";
...
import taMockWords from "./words/ta-mock-words.json";
import taCasesWords from "./words/ta-cases-words.json";
import taCiWords from "./words/ta-ci-words.json";
...
const SCENE_COMPS = [
  SceneTaIntro, SceneTaLayers, SceneTaMock, SceneTaCases,
  SceneTaCi, SceneTaOutro,
];
const SCENE_WORDS = [
  taIntroWords, taLayersWords, taMockWords, taCasesWords,
  taCiWords, taOutroWords,
];
...
export const TestArch: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
      <Audio src={staticFile("audio/test-arch/test-arch.mp3")} volume={0.9} />
      {scenes.map((s, i) => {
