...
import { SceneArch } from "./SceneArch";
import { SceneRoutes } from "./SceneRoutes";
import { Subtitle } from "../../Subtitle";

import introWords from "./words/svo-intro-words.json";
import archWords from "./words/svo-arch-words.json";
import routesWords from "./words/svo-routes-words.json";
...
const SCENE_COMPS = [SceneIntro, SceneArch, SceneRoutes];
const SCENE_WORDS = [introWords, archWords, routesWords];
...
export const SV_OVERVIEW_FRAMES = scenes[scenes.length - 1].from + scenes[scenes.length - 1].dur;
...
export const SvOverview: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
    <Audio src={staticFile("audio/sv-overview/sv-overview.mp3")} volume={0.9} />
    {scenes.map((s, i) => {
