...
import { SceneEra } from "./SceneEra";
import { SceneWhat } from "./SceneWhat";
...
import eraWords from "./words/era-words.json";
import whatWords from "./words/what-words.json";
import compareWords from "./words/compare-words.json";
import featuresWords from "./words/features-words.json";
import runtimeWords from "./words/runtime-words.json";
...
const SCENE_COMPS = [
  SceneIntro, SceneEra, SceneWhat,
  SceneCompare, SceneFeatures, SceneRuntime, SceneOutro,
];
const SCENE_WORDS = [
  introWords, eraWords, whatWords,
  compareWords, featuresWords, runtimeWords, outroWords,
];
...
export const Hono2026: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
    <Audio src={staticFile("audio/hono-2026/hono-2026.mp3")} volume={0.9} />
    {scenes.map((s, i) => {
