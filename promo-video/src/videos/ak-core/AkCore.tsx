...
import { SceneAkcoreIntro } from "./SceneAkcoreIntro";
import { SceneAkcoreDesign } from "./SceneAkcoreDesign";
import { SceneAkcoreSummary } from "./SceneAkcoreSummary";
import { Subtitle } from "../../Subtitle";

import akcoreIntroWords from "./words/akcore-intro-words.json";
import akcoreDesignWords from "./words/akcore-design-words.json";
import akcoreSummaryWords from "./words/akcore-summary-words.json";
...
const SCENE_COMPS = [SceneAkcoreIntro, SceneAkcoreDesign, SceneAkcoreSummary];
const SCENE_WORDS = [akcoreIntroWords, akcoreDesignWords, akcoreSummaryWords];
...
export const AK_CORE_FRAMES = scenes[scenes.length - 1].from + scenes[scenes.length - 1].dur;
...
export const AkCore: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
      <Audio src={staticFile("audio/ak-core/ak-core.mp3")} volume={0.9} />
      {scenes.map((s, i) => {
