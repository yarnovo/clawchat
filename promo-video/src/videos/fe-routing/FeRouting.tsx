...
import introWords from "./words/fer-intro-words.json";
import lazyWords from "./words/fer-lazy-words.json";
...
const SCENE_COMPS = [SceneIntro, SceneLazy];
const SCENE_WORDS = [introWords, lazyWords];
...
export const FE_ROUTING_FRAMES = scenes[scenes.length - 1].from + scenes[scenes.length - 1].dur;
...
export const FeRouting: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#FAF9F6" }}>
    <Audio src={staticFile("audio/fe-routing/fe-routing.mp3")} volume={0.9} />
    {scenes.map((s, i) => {
