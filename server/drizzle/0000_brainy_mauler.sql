...
CREATE TYPE "public"."listing_status" AS ENUM('draft', 'pending', 'published', 'rejected');--> statement-breakpoint
CREATE TYPE "public"."usage_type" AS ENUM('chat', 'token', 'skill_install');--> statement-breakpoint
CREATE TABLE "agents" (
...
--> statement-breakpoint
ALTER TABLE "market_listings" ADD CONSTRAINT "market_listings_agent_id_agents_id_fk" FOREIGN KEY ("agent_id") REFERENCES "public"."agents"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
